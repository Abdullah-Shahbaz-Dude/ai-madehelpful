...
const Prompts: FC = () => {
  ...
  useEffect(() => {
    document.title = "Prompt Library - Ai made helpful";
    return () => {
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white dark:from-slate-950 dark:to-background-dark pt-16 pb-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Unlock the full potential of AI with our curated collection of
            production-ready prompts for ChatGPT, Midjourney, Claude, and more.
          </p>
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-8 items-center opacity-60">
            {SUPPORTED_TOOLS.map((tool) => (
              <div key={tool.name} className="flex flex-col items-center gap-2">
                ...
                >
                  <span className={`material-icons-outlined ${tool.iconColor}`}>
                    {tool.icon}
                  </span>
                </div>
