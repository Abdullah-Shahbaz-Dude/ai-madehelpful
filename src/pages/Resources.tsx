...
const RESOURCES_DATA = [
  {
    type: 'PDF' as const,
    typeClass: 'bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400',
    icon: 'file_download',
    badge: 'FREE DOWNLOAD',
  ...
  {
    type: 'Template' as const,
    typeClass: 'bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400',
    icon: 'link',
    badge: 'TEMPLATE',
  ...
  {
    type: 'Guide' as const,
    typeClass: 'bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400',
    icon: 'description',
    badge: 'GUIDE',
...
const Resources: FC = () => {
  ...
  useEffect(() => {
    document.title = 'Resources - Ai made usefull'
    return () => {
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white dark:from-slate-950 dark:to-background-dark pt-16 pb-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 dark:bg-blue-900/30 text-primary mb-6">
            <span className="material-icons-outlined text-[14px] mr-1">folder</span>
            Templates & Guides
          </span>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Free automation templates, PDF guides, and blueprints to level up your AI workflows.
          </p>
          ...
          {filteredResources.map((resource) => (
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <span className="material-icons-outlined text-slate-400">{resource.icon}</span>
                <span
