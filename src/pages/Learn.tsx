...
const Learn: FC = () => {
  ...
  useEffect(() => {
    document.title = 'Tutorials - Ai made usefull'
    return () => {
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white dark:from-slate-950 dark:to-background-dark pt-16 pb-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-6">
            Tutorials <span className="text-primary">Library</span>
          </h1>
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Step-by-step video guides and written tutorials to master AI tools. From beginner to
            advanced workflows.
          </p>
