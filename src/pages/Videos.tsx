...
const FILTERS = ['All', 'Beginner', 'Intermediate', 'Advanced', 'Automation'] as const
...
const TUTORIALS = [
  {
    ...
    level: 'Automation',
    levelClass: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300',
  ...
  },
  {
    ...
    level: 'Beginner',
    levelClass: 'bg-white/90 dark:bg-slate-900/90 text-slate-700 dark:text-slate-300',
...
const Videos: FC = () => {
  ...
  useEffect(() => {
    document.title = 'Videos - Ai made usefull'
    return () => {
  ...
  const filteredTutorials =
    activeFilter === 'All'
      ? TUTORIALS
      : TUTORIALS.filter((t) => t.level.toLowerCase() === activeFilter.toLowerCase())
      ...
      <section className="bg-gradient-to-b from-blue-50 to-white dark:from-slate-950 dark:to-background-dark pt-16 pb-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 dark:bg-blue-900/30 text-primary mb-6">
            <span className="material-icons-outlined text-[14px] mr-1">video_library</span>
            Video Library
          </span>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Step-by-step video tutorials to master AI tools. From beginner to advanced workflows.
          </p>
